...
import com.example.moHaeng.RecommendItem
import com.example.moHaeng.databinding.RecyclerviewRecommendItemBinding


class RecommendAdapter(private val itemList: List<RecommendItem>) : RecyclerView.Adapter<RecommendAdapter.ViewHolder>() {
