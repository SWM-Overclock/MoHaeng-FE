...
import com.example.moHaeng.databinding.FragmentFindMapBinding
import java.util.Locale

class FindMapFragment : Fragment(), KakaoMapsFragment.OnLocationSelectedListener {

    private lateinit var binding: FragmentFindMapBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFindMapBinding.inflate(inflater, container, false)
